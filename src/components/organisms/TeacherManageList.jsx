...
const showConfirmation = (assignmentId, currentStatus) => {
    setConfirmModal({
      isOpen: true,
      assignmentId,
      currentStatus
...
return (
    <>
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    <Switch
                      ...
                      onChange={() => showConfirmation(assignment.Id, assignment.isLive)}
                    />
      ...
      <ConfirmationModal
        ...
        title={confirmModal.currentStatus ? "Deactivate Assignment" : "Activate Assignment"}
        message={
          confirmModal.currentStatus 
            ? "Students will no longer be able to access this assignment. Are you sure you want to deactivate it?"
            : "Students will be able to access and submit this assignment. Are you sure you want to activate it?"
        }
        confirmText={confirmModal.currentStatus ? "Deactivate" : "Activate"}
        cancelText="Cancel"
        isDestructive={confirmModal.currentStatus}
      />
    </>
  );
};
